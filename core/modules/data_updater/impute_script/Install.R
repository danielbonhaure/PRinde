...
suppressPackageStartupMessages(if(!require('lazyeval')) { install.packages("lazyeval", dependencies=TRUE); require('lazyeval') }) # sudo apt install libcurl4-openssl-dev
suppressPackageStartupMessages(if(!require('sirad')) { install.packages("sirad", dependencies=TRUE); require('sirad') }) # sudo apt install udunits-bin libudunits2-0 libudunits2-dev
...
suppressPackageStartupMessages(if(!require('gstat')) { install.packages("gstat"); require('gstat') }) # sudo apt install libgeos-dev
suppressPackageStartupMessages(if(!require('geosphere')) { install.packages("geosphere"); require('geosphere') })
suppressPackageStartupMessages(if(!require('rgdal')) { install.packages("rgdal"); require('rgdal') });  # sudo apt install libproj-dev libgdal-dev
